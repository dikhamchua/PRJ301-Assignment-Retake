    ...
    <body>
        ...
        <div class="wrapper">
            <div class="sidebar">
                <h2>Sidebar</h2>
                <ul>
                    <li><a href="search?keyword="><i class="fas fa-home"></i>Home</a></li>
                    <li><a href="addProductAdmin"><i class="fas fa-user"></i>Add Product</a></li>
                                            ...
                                            <tbody>
                                                <c:forEach items="${sessionScope.listProducts}" var="product" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--Price-->
                                                        <td>
                                                            <fmt:formatNumber type="currency" value="${product.price.price}">
                                                            </fmt:formatNumber>
                                                        </td>
                                                        <!--Edit-->
                                                        <td>
