<%-- 
    ...
    Created on : Jul 11, 2022, 2:57:41 AM
...
<html>
    ...
    <body>
        ...
        <!--Product section-->
        <jsp:include page="product-section-dashboard.jsp"></jsp:include>
            
        <!--Pagination section-->
        <jsp:include page="pagination-section-dashboard.jsp"></jsp:include>
